                    ...
                    @foreach($topics_array[$key] as $secondKey => $topic)
                        <div class="col-md-4">
                            <div class="feature-box-103 text-center bmargin">
                                <div id="simulation_percentage_{{$category}}_{{$secondKey}}" data-percentage={{$percentages[$key][$secondKey]}} style="height: 300px; width: 100%;"></div>
                        </div>
                </div>
                @endforeach
        </div>
...
<h3 class="margin-left-3 margin-top2">Estadisticas generales - Simulaciones.</h3>
<br>
<div id="chartContainerSimulation" class="col-centered" style="height: 400px; width: 85%;margin-top:60px;"></div>
<script>
    $(document).ready(function(){
        ...
        for(var i = 0; i < categories.length; i++){
            for(var j = 0; j < topics[i].length; j++ ){
                ...
                charts[counter] = new CanvasJS.Chart("simulation_percentage_"+categories[i]+"_"+j, {
                    theme: "light2",
